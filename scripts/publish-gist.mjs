...
const FILE_MAP = [
  ...
  ['README.md', 'README.md'],
  ['plugins/hello-world/paseo.json', 'plugins-hello-world-paseo.json'],
  ['plugins/hello-world/package.json', 'plugins-hello-world-package.json'],
  ['plugins/hello-world/index.js', 'plugins-hello-world-index.js'],
  ['plugins/logger/paseo.json', 'plugins-logger-paseo.json'],
  ['plugins/logger/package.json', 'plugins-logger-package.json'],
  ['plugins/logger/index.js', 'plugins-logger-index.js'],
  ['tutorials/01-quick-start.md', 'tutorials-01-quick-start.md'],
  ['tutorials/02-workspaces.md', 'tutorials-02-workspaces.md'],
  ['tutorials/03-agents.md', 'tutorials-03-agents.md'],
  ['tutorials/04-schedules.md', 'tutorials-04-schedules.md'],
  ['tutorials/05-plugins.md', 'tutorials-05-plugins.md'],
  ['tutorials/06-providers.md', 'tutorials-06-providers.md'],
