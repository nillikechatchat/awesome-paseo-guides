...
const FILE_MAP = [
  ...
  ['tutorials/02-connectivity.md', 'tutorials-02-connectivity.md'],
  ['tutorials/03-workspaces.md', 'tutorials-03-workspaces.md'],
  ['tutorials/04-providers.md', 'tutorials-04-providers.md'],
  ['tutorials/05-orchestration.md', 'tutorials-05-orchestration.md'],
  ['tutorials/06-schedules.md', 'tutorials-06-schedules.md'],
  ['tutorials/07-plugins.md', 'tutorials-07-plugins.md'],
  ['tutorials/08-cli-reference.md', 'tutorials-08-cli-reference.md'],
  ['tutorials/09-sdk.md', 'tutorials-09-sdk.md'],
  ['tutorials/10-browser-voice.md', 'tutorials-10-browser-voice.md'],
